...
namespace GTTServerBackendTest
{
    ...
    public class GTTServerBackendParallelTest
    {
        ...
        public async Task Test_2_Client_Add_Message_In_ParallelAsync()
        {
            ...
            Console.WriteLine("======================");
            Console.WriteLine("ChatBox 3 :");
            ChatBox3.RoomMessageList.ForEach(x => Console.WriteLine(x.Author + " : " + x.Message));
             Console.WriteLine("======================");
            Console.WriteLine("ChatBox 4 :");
            ChatBox4.RoomMessageList.ForEach(x => Console.WriteLine(x.Author + " : " + x.Message));
             Console.WriteLine("======================");
            Console.WriteLine("ChatBox 5 :");
            ChatBox5.RoomMessageList.ForEach(x => Console.WriteLine(x.Author + " : " + x.Message));
         }
    }
}
